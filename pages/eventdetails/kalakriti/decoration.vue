  ...
  <div class="event-details-wrapper">
    ...
    <div class="detail-container">
      ...
      <div class="detail-rules">
        ...
        <ul>
          <li>
            Theme of the competition is restricted to “Cultural Heritage”.
          </li>
          <li>
            In group there must be minimum 4 and maximum 6 members and boy's
            participation in a group is Mandatory.
          </li>
          <li>There will be only one round of competition.</li>
          <li>Everything Will be provided by Organizers.</li>
          <li>
            The participants will have to Decorate their respective Sets On or
            before the 1st day of Technorollix.
          </li>
          <li>
            Cash prizes will be awarded to First, Second and Third position
            holders, along with Certificates of Achievement. A Certificate of
...
<script>
export default {
  name: 'DrishyaamEventPage',
  data() {
    return {
      event: {
        name: 'Drishyaam (Decoration)',
        img: 'drishyaam.jpg',
        event_desc:
