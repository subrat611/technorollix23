  ...
  <div class="event-details-wrapper">
    ...
    <div class="detail-container">
      ...
      <div class="detail-rules">
        ...
        <ul>
          <li>Theme of the competition is restricted to “ ”.</li>
          <li>
          ...
          <li>
            The participants have to bring their own material which they require
            in making rangoli. Colors Will be provided by Organizers.
          </li>
          <li>
            The participants will be given 2hr for making rangoli. No extra time
      ...
      <div class="detail-judg">
        ...
        <p>
          <b
            >Not Decided. (Infront of Chem. Lab / Backside of Biotech lab/
            Infront of Mech. Workshop)</b
          >
        </p>
      </div>
